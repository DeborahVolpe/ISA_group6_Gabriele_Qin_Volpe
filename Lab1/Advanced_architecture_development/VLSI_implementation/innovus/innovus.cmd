...
#  Created on Sat Nov  7 11:13:59 2020                
#                                                     
#######################################################
...
gui_select -rect {122.329 37.602 122.329 6.826}
panPage 0 1
panPage 0 1
...
placeDesign
fit
zoomBox 3.026 96.981 107.659 44.444
fit
...
read_activity_file -format VCD -scope /tb_fir/UUT -start {} -end {} -block {} ../vcd/filter_syn.vcd
set_power -reset
set_powerup_analysis -reset
set_dynamic_power_simulation -reset
report_power -rail_analysis_format VS -outfile .//Filter.rpt
report_power -outfile power_report_opt.txt -sort { total }
