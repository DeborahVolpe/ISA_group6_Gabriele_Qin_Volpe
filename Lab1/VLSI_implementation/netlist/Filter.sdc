...
# Created by write_sdc on Fri Nov  6 10:45:09 2020
...
create_clock [get_ports CLK]  -period 13.64  -waveform {0 6.82}
...
set_input_delay -clock CLK  -max 0.5  [get_ports {a1[10]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a1[9]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a1[8]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a1[7]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a1[6]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a1[5]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a1[4]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a1[3]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a1[2]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a1[1]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a1[0]}]
