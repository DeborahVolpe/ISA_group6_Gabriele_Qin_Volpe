...
#  Created on Tue Feb  9 11:11:58 2021                
#                                                     
#######################################################
...
set init_verilog ../netlist/synopsys/RISCV.v
...
setDrawView fplan
win
dumpToGIF image/ss_Placement.fplan.gif
getDrawView
setDrawView amoeba
win
dumpToGIF image/ss_Placement.amoeba.gif
getDrawView
setDrawView place
win
dumpToGIF image/ss_Placement.place.gif
...
setDrawView fplan
win
dumpToGIF image/ss_PostPlacement.fplan.gif
getDrawView
setDrawView amoeba
win
dumpToGIF image/ss_PostPlacement.amoeba.gif
getDrawView
setDrawView place
win
dumpToGIF image/ss_PostPlacement.place.gif
checkPlace checkplace.ss.rpt
getFillerMode -quiet
...
setDrawView fplan
win
dumpToGIF image/ss_Route.fplan.gif
getDrawView
setDrawView amoeba
win
dumpToGIF image/ss_Route.amoeba.gif
getDrawView
setDrawView place
win
dumpToGIF image/ss_Route.place.gif
checkPlace checkplace.ss.rpt
...
setDrawView fplan
win
dumpToGIF image/ss_PostRoute.fplan.gif
getDrawView
setDrawView amoeba
win
dumpToGIF image/ss_PostRoute.amoeba.gif
getDrawView
setDrawView place
win
dumpToGIF image/ss_PostRoute.place.gif
checkPlace checkplace.ss.rpt
...
set_default_switching_activity -input_activity 0.2 -period 10.0
read_activity_file -reset
read_activity_file -format VCD -scope tb_RISC_file/DUT -start {} -end {} -block {} ../vcd/RISCV.vcd
set_power -reset
set_powerup_analysis -reset
set_dynamic_power_simulation -reset
report_power -rail_analysis_format VS -outfile .//RISCV.rpt
...
set_default_switching_activity -input_activity 0.2 -period 10.0
read_activity_file -reset
read_activity_file -format VCD -scope tb_RISCV_file/DUT -start {} -end {} -block {} ../vcd/RISCV.vcd
set_power -reset
set_powerup_analysis -reset
set_dynamic_power_simulation -reset
report_power -rail_analysis_format VS -outfile .//RISCV.rpt
